 ...
 */
function saveIntervieweeDetails(userId, beforeSeniorSecData, afterSeniorSecData, jobData, internshipData, skillData, courseData, certificationData, testData, projectData, additionalData, callback) {
...
function updateBeforeSeniorSecOfInterviewee(userId, beforeSeniorSecData, callback) {
    ...
    fetchedInterviewee.save(errInSave, savedInterviewee) {
        if (errInSave) {
            callback({
                type: CONSTANTS.ERROR_TYPES.DB_ERROR,
 ...
 */
function newInterviewee(userData, beforeSeniorSecData, afterSeniorSecData, jobData, internshipData, skillData, courseData, certificationData, testData, projectData, additionalData, callback) {
    async.waterfall(
        [
            ...
            function (savedUser, waterfallCallback) {
                saveIntervieweeDetails(savedUser._id, beforeSeniorSecData, afterSeniorSecData, jobData, internshipData, skillData, courseData, certificationData, testData, projectData, additionalData, function (err, savedInterviewee) {
