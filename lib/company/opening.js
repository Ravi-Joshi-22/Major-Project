 ...
 */
function getAllOpenings(companyId, openingId, callback) {
  JobOpening.find(
    {
      company_id: companyId,
    },
...
function getAllOpeningsOfCompany(userId, openingId, callback) {
  async.waterfall(
    [
      function(waterfallCallback) {
        userHelper.getCompanyDetailsFromUser(userId, function(
      ...
      function(fetchedCompany, waterfallCallback) {
        getAllOpenings(fetchedCompany._id, openingId, function(
          err,
          savedCompany
        ) {
          waterfallCallback(err, savedCompany);
