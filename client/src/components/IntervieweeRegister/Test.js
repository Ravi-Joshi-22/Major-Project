    ...
    render() {
        return (
            <div >
                        ...
                        <section class="modal-card-body">
                            ...
                            <div className="field">
                                ...
                                <div className="control has-icons-left ">
                                    <input className="input" type="text" placeholder="Ex:Gate" required value={this.state.name} onChange={this.updateName} />
                            ...
                            <div className="field">
                                ...
                                <div className="control has-icons-left ">
                                    <input className="input" type="number" placeholder="Should be less than 100" required value={this.state.score} onChange={this.updateScore} />
                                    <span className="icon is-small is-left">
                            ...
                            <div className="field " style={{ width: '100%' }}>
                                ...
                                <div className="control has-icons-left ">
                                    ...
                                    <input className="input" type="date" value={this.state.date} onChange={this.updatedDate} />
                                    <span className="icon is-small is-left">
                ...
                <a class="button is-black is-inverted  is-hovered" onClick={this.renderModal}> +Add Test </a>
