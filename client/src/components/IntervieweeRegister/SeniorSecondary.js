        ...
        return (
            ...
            console.log(this.state),
                <div>
                    <div className={this.state.currentModalClass}>
                        ...
                        <div class="modal-card">
                            <header class="modal-card-head">
                                <p class="modal-card-title">Senior Secondary (12) Education Details</p>
                            ...
                            <section class="modal-card-body">
                                ...
                                <div class="field ">
                                    ...
                                    <p class="control has-icons-left ">
                                        <span class="select is-fullwidth ">
                                            <select value={this.state.year_of_comp} onChange={this.updateYearOfCompletion}>
                                ...
                                <div className="field">
                                    ...
                                    <div className="control has-icons-left has-icons-right">
                                        <input className="input" type="text" placeholder="Ex: CBSE" value={this.state.board} onChange={this.updateBoard} />
                                ...
                                <div className="field">
                                    ...
                                    <div className="control has-icons-left has-icons-right">
                                        <input ref="nameInput" className="input" type="text" placeholder="Ex: Delhi public School" value={this.state.school} onChange={this.updateSchool} />
                                        <span className="icon is-small is-left">
                    ...
                    <a class="button is-black is-inverted  is-hovered" onClick={this.renderModal}> +Add  Senior Secondary </a>
