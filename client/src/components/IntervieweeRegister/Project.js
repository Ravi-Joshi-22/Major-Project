    ...
    render() {
        return (
            ...
            <div >
                        ...
                        <section class="modal-card-body">
                            ...
                            <div className="field">
                                ...
                                <div className="control has-icons-left has-icons-right">
                                    <input className="input" type="text" placeholder="Smart Hyre" required value={this.state.title} onChange={this.updateTitle} />
                            ...
                            <label class="checkbox">
                                <input type="checkbox" value={this.state.currently_working} onChange={this.updateOngoing} />
                                Currently ongoing
                        </label>
                            <div className="field">
                                <label className="label">Project Description</label>
                                <div className="control has-icons-left has-icons-right">
                                    <textarea class="textarea is-hovered" type="text" placeholder="Project Description" value={this.state.description} onChange={this.updatedDescription}></textarea>
                            ...
                            <div className="field">
                                ...
                                <div className="control has-icons-left has-icons-right">
                                    <input className="input" type="url" pattern="https?://.+" placeholder="https://www.example.com" required value={this.state.url} onChange={this.updateLink} />
                                    <span className="icon is-small is-left">
                ...
                <a class="button is-black is-inverted  is-hovered" onClick={this.renderModal}> +Add Project </a>
