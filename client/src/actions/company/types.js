...
export const COMPANY_DASH = 'company_dash';
export const HIDE_COMPANY_OPENING_MODAL = 'hide_company_opening_modal';
...
export const COMPANY_OPENING_RESULTS = 'company_openins_results';
